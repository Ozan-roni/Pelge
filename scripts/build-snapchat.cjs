...
const runtime = ['SnapchatEssentialUI.js','SnapchatExperience.js','SnapchatMobileUI.js'].map(file=>fs.readFileSync(path.join(root,'dist/scripts',file),'utf8').trim()).join('\n\n');
